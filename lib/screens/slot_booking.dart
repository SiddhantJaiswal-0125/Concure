...
Covidvaccinebypin covidvaccinebypinFromJson(String str) =>
    Covidvaccinebypin.fromJson(json.decode(str));

String covidvaccinebypinToJson(Covidvaccinebypin data) =>
...
class Covidvaccinebypin {
  ...
  factory Covidvaccinebypin.fromJson(Map<String, dynamic> json) =>
      Covidvaccinebypin(
        centers:
            List<Centers>.from(json["centers"].map((x) => Centers.fromJson(x))),
      );
