                                    ...
                                    return Theme(
                                      ...
                                      data: ThemeData.dark().copyWith(
                                        colorScheme: ColorScheme.dark(
                                          ...
                                          // surface: Colors.pink,
                                          surface:  Color(0xff202c3b),
                                          onSurface: Colors.yellow,
                                        ),
                                        // dialogBackgroundColor: Colors.green[900],
                                        dialogBackgroundColor:  Color(0xff202c3b),
                                      ),
                                      child: picker,
                                    );
                                  }).then((selectedDate) {
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  ...
                                  for (Session si in s) {
                                    ...
                                    int age =
                                        int.parse(si.minAgeLimit.toString());
                                    // print("date check : "+(date1==date).toString());
                                    if (date1 == date) {
                                      if (age == 18)
                                        eighteen = true;
                                      else if (age == 45) fortyfive = true;
                                    }
                                    ...
                                    child: new Container(
                                      ...
                                      children: <Widget>[
                                        ...
                                        ListTile(
                                            ...
                                            // onPressed:
                                            leading: sdata.availableCapacity > 0
                                                ? GestureDetector(
                                                    onTap: () {
                                                      try {
                                                        launch(
                                                            'https://cowin.gov.in/home');
